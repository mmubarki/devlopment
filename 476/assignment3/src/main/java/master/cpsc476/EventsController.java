...
public class EventsController {
    ...
    public String viewEvent(@PathVariable Long id, Model model, HttpSession session){
        ...
        if(id == null){
            model.addAttribute("message", "ERROR: event Id is null");
            return "redirect:/Events/list";
        }
        Event event = eventDAO.findById(id);
        
        if(event == null){
            model.addAttribute("message", "ERROR: can't find events");
            return "redirect:/Events/list";
        }
    ...
    public String signin(@ModelAttribute("loginDetail") LoginDetail loginDetail, 
        ...
        User user = new User(loginDetail);
        
        System.out.println("signin for :"+user.getEmail());
        System.out.println("signin for :"+user.getPassword());
        
        user = userDAO.isMatch(user);
